...
# Install system dependencies with optimized build flags
...
# Create model directory and download with retries
...
# Create non-root user with optimized permissions
...
# Install requirements with optimized pip
